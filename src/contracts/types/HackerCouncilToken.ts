...
export interface HackerCouncilTokenInterface extends utils.Interface {
  functions: {
...
export interface HackerCouncilToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HackerCouncilTokenInterface;
